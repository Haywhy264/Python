#!/usr/bin/env python3
"""Simple GUI launcher for the Modbus simulator v2."""
...
class SimulatorGUI(tk.Tk):
    def __init__(self) -> None:
        super().__init__()
        self.title("Modbus Meter Simulator V2")
        ...
        self._script_path = Path(__file__).with_name("modbus_meter_simulator_v2.py")
